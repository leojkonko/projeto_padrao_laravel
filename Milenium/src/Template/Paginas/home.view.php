            ...
            <div class="col-lg-12 w-100 col-12 bg-dange d-flex align-items-center justify-content-center">
                ...
                <div class="accordion-item">
                        ...
                        <div id="collapseOne<?=$i?>" class="accordion-collapse collapse <?=$show?> overflow-hidden" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body bg-cinza row px-sm-2 px-1 py-2 pb-sm-1 pb-lg-2 ">
                               
                                <div class=" ps-xxl-1 col-lg-6 col-xl-3 col-xxl-3 col-md-6 col-12 p-0 imagem d-flex">
                                    <div class="ratio ratio-1x1">
                                    <img class="w-100 h-100 img-infos  object-fit-cover" src="<?= asset('images/banners/caminhao.png') ?>" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-xl-3 col-xxl-3 col-md-6 col-12 p-0 bg-white infos px-lg-1 px-lg-1 px-xl-1 px-1 py-1 d-flex justify-content-center align-items-center flex-column">
                                    <div class="m-auto">
                                        <h2 class="h2 h2-20 text-lg-start ps-lg-0-50 ps-0 mb-1 mt-1 w-100">Matriz - Caxias do Sul</h2>
                                        <p class="p p-16 text-lg-start w-100">
                                            <svg class="ms-0-50 me-0-50" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="w-100 text-center">
                        <button class="btn btn-danger text-white p mt-2">
                            <img class="me-0-50" width="30px" src="<?= asset('images/icones/ficheiro-pdf.png') ?>" alt="">    
