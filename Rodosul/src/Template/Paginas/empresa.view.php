        ...
        <div class="container py-lg-4 py-2">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <!-- SWIPER 1 POR 1 -->
                    <div class="swiper mySwiper-empres banner-swiper ">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide ratio ratio-1x1">
                                <img src="<?= asset('images/banners/solucoes.png') ?>" alt="">
                            </div>
                ...
                <div class="col-lg-6 conteudo d-flex align-items-center py-4 py-sm-4 py-md-4 py-lg-0 py-xl-0 py-xxl-0">
                    <div class="row">
                        <div class="col-12 p px-xl-4 px-lg-2 text-lg-start text-center">
