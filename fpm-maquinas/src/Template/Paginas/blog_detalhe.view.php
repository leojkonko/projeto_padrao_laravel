<main id="post">
    <section class="blog-detalhe py-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 m-auto pb-lg-3 pb-2 position-relative">
                ...
                <div class="col-12">
                        <div class="d-flex justify-content-center align-items-center">
                            <div class="flex-column">
                                ...
                                <h6 class="h5 mr-auto mt-2">Data: 01/01/2022</h6>
                                <div class="p mt-2 text-lg-start text-center">Compartilhe: 
