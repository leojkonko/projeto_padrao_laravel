    ...
    <div class="row p-0">
        ...
        <div class="col-lg-7 p-0 bg-azul mt-lg-2 d-flex align-items-center pb-lg-0 pb-2">
            <div class="row p-0 w-100">
                <div class="col-lg-5 site mt-2">
                    <div class="d-flex justify-content-center h-100 align-items-center text-lg-start text-center">
                        <ul class="py-lg-3">
                            <li>
                                <a href="">Sobre nós</a>
                            </li>
                    ...
                    <div class="d-flex justify-content-center align-items-center h-100">
                        <div class="flex-column infos ">
                            ...
                            <div class="p d-flex text-lg-start text-center">
                                ...
                                <svg class="d-flex d-lg-none svg-alinhamento" width="34" height="25" viewBox="0 0 14 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7 0C3.1351 0 0 3.07264 0 6.86055C0 12.9353 7 19 7 19C7 19 14 12.9353 14 6.86055C14 3.07264 10.8649 0 7 0ZM7 9.8123C5.3348 9.8123 3.98825 8.49258 3.98825 6.86055C3.98825 5.22853 5.3348 3.9088 7 3.9088C8.6652 3.9088 10.0117 5.22853 10.0117 6.86055C10.0117 8.49258 8.6652 9.8123 7 9.8123Z" fill="white"/>
                                </svg>    
                                Av. João Pereira de Vargas, 3183 Sapucaia do Sul - RS, Brasil</a>
                            </div>

                            <div class="p d-flex mt-2 text-lg-start text-center">
                                <svg class="me-1 d-none d-lg-flex" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
