        ...
        <section class="py-2 py-lg-4">
            <div class="container">
                <div class="row gy-2 justify-content-center text-center text-lg-start">
                    <div class="col-12 col-lg-8">
                        @if ($post->image->count())
                            <div class="ratio ratio-16x9">
                                <x-gallery-swiper :images="$post->image" />
                    ...
                    <div class="col-12 col-lg-8">
                        @if ($post->post_date)
                            <small class="text-muted mb-1 d-block">Data: {{ $post->post_date?->format('d/m/Y') }}</small>
                        @endif
                        <div class="mb-1">
                            <h1 class="h4 text-primary fw-bold mb-0">{{ $post->title }}</h1>
                        </div>
