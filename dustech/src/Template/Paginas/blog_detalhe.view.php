                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-12 p py-1">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde nostrum velit nemo ea, ut, porro, 
                                ...
                                cum quas!</p>
                                <div class="fonte">
                        Fonte: wwww.fonte.com.br
                                </div>
                                <div class="aplicabilidade p d-flex align-items-center pt-2">
                                    <p>Compartilhe:</p>
                                    <div class="ms-2 mb-1 d-flex">
                                    <a class="d-flex btn btn-outline-custom ms-0-50 " target="_blank" aria-label="Whatsapp">
                                    ...
                                    <a class="d-flex btn btn-outline-custom ms-0-50 " target="_blank" aria-label="Facebook">
